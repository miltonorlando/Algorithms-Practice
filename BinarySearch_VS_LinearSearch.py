...
This code compares binary search versus linear search

For this to run properly please be sure to have the following files in the same folder as this file:
